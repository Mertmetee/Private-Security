...
Public Class OzelGuvenlikKayitFormu
    ...
    Private Sub OzelGuvenlikKayitFormu_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            'Hesaplanan Alan Ekleyerek Yaşı Hesaplama
            Dim YilHesaplaColumn As New DataColumn()
            YilHesaplaColumn.ColumnName = "Yil"
            YilHesaplaColumn.DataType = GetType(Integer)
            YilHesaplaColumn.Expression = DateTime.Today.Year
            OzGuVTDS.Tables("OzelGuvenlikBilgileriTablosu").Columns.Add(YilHesaplaColumn)

            Dim YasHesaplaColumn As New DataColumn()
            YasHesaplaColumn.ColumnName = "Yas"
            YasHesaplaColumn.DataType = GetType(Integer)
            YasHesaplaColumn.Expression = "Yil-Convert(SubString(Convert(DogumTarihi,'System.String'),7,4),'System.Int32')"
            OzGuVTDS.Tables("OzelGuvenlikBilgileriTablosu").Columns.Add(YasHesaplaColumn)
    ...
    Private Sub NesneleriBagla()
        ...
        YasTBox.DataBindings.Add("Text", OzelGuvenlikBilgileriTablosuBS, "Yas")
